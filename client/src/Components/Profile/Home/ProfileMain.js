...
const ProfileMain = () => {
    ...
    React.useEffect(() => {
        async function getImages () {
            ...
            const response2 = await fetch('http://localhost:4000/images/image/'+data.profilePic+".png", requestOptions).then ((res) => res.blob());
            ...
            for (const element of arr) {
                ...
                if(!songNames.includes(element.toString())) {
                    setSongs(songsArr => [...songsArr, <div key={element}>
